...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "Calypso@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "Calypso API";

        private String description = "Calypso API documentation";
